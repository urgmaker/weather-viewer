...
public class SignInServlet extends WeatherTrackerBaseServlet {
    ...
    @Override
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, InvalidParameterException, UserNotFoundException, WrongPasswordException {
